...
{% image src="/images/illustration-project_highlights.svg" alt="Project Highlights" className="block dark:hidden" /%}

{% image src="/images/illustration-project_highlights-dark.svg" alt="Project Highlights" className="hidden dark:block" /%}
